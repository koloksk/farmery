...
/*        Menu.speed1 = new ItemStack(Material.POTION, 1, (short) 8258);
        ...
        lore.add(ColorUtil.fixColors(" &8» &cCzas trwania: &63min"));
        lore.add(ColorUtil.fixColors(" &8» &cKoszt: &610x EMERALD BLOKOW"));
        meta.setLore(lore);
        Menu.speed2.setItemMeta(meta);
        Menu.sila1 = new ItemStack(Material.POTION, 1, (short) 8201);
        meta = Menu.sila1.getItemMeta();
        lore = new ArrayList<>();
        lore.add(ColorUtil.fixColors(" &8» &cCzas trwania: &6150s"));
        lore.add(ColorUtil.fixColors(" &8» &cKoszt: &632x EMERALD BLOKOW"));
        meta.setLore(lore);
...
/*        Menu.skok1 = new ItemStack(Material.LEATHER_BOOTS);
        ...
        LeatherArmorMeta meta2 = (LeatherArmorMeta) Menu.skok2.getItemMeta();
        meta2.setDisplayName(ColorUtil.fixColors("&9Wyskoki skok II"));
        meta2.setColor(Color.WHITE);
        lore = new ArrayList<>();
        lore.add(ColorUtil.fixColors(" &8» &cCzas trwania: &660s"));
        lore.add(ColorUtil.fixColors(" &8» &cKoszt: &66x EMERALD BLOKOW"));
        meta2.setLore(lore);
        ...
        lore = new ArrayList<>();
        lore.add(ColorUtil.fixColors(" &8» &cCzas trwania: &6300s"));
        lore.add(ColorUtil.fixColors(" &8» &cKoszt: &62x EMERALD BLOKOW"));
        meta.setLore(lore);
        ...
        lore = new ArrayList<>();
        lore.add(ColorUtil.fixColors(" &8» &cCzas trwania: &6300s"));
        lore.add(ColorUtil.fixColors(" &8» &cKoszt: &65x EMERALD BLOKOW"));
        meta.setLore(lore);
    ...
    public static void build() {
        ...
        Menu.effectmenu.setItem(10, Menu.blank);
        ...
        Menu.effectmenu.setItem(15, Menu.blank);
